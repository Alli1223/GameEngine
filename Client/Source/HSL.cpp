...
vec3 HSL::TurnToRGB()
{
	...
	else
	{
		...
		Uint8 r = (255 * HueToRGB(arg1, arg2, (H + 1.0 / 3.0)));
		Uint8 g = (255 * HueToRGB(arg1, arg2, H));
		Uint8 b = (255 * HueToRGB(arg1, arg2, (H - 1.0 / 3.0)));
		vec3 C = { r, g, b };
		return C;
	}
}

HSL HSL::TurnToHSL(const vec3& C)
{
